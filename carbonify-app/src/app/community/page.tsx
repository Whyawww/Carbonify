    ...
    <div className="min-h-screen w-full pt-32 pb-20">
      <div className="container mx-auto px-4 max-w-5xl">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2">
          Bergabung dengan Komunitas Carbonify
        </h1>
        <TypeAnimation
          sequence={[
            'Bersama kita lebih kuat dalam menciptakan perubahan.',
            2000,
          ]}
          wrapper="p"
          speed={50}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
          ...
          <div className="p-[1px] bg-gradient-to-r from-green-400/30 to-cyan-400/30 rounded-2xl">
            <div className="bg-gray-900/80 backdrop-blur-lg p-8 rounded-2xl h-full flex flex-col items-center justify-center space-y-4">
              ...
              <h2 className="text-2xl font-bold text-white">
                Gabung Diskusi di Discord
              </h2>
              <p className="text-gray-400">
                Terhubung dengan anggota lain, bagikan ide, dan diskusikan
                solusi iklim di server Discord kami.
              </p>
              <a
                href="#"
                className="mt-4 font-bold py-2 px-6 rounded-md text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600"
              >
                Gabung Sekarang
              </a>
            </div>
          ...
          <div className="p-[1px] bg-gradient-to-r from-green-400/30 to-cyan-400/30 rounded-2xl">
            <div className="bg-gray-900/80 backdrop-blur-lg p-8 rounded-2xl h-full flex flex-col items-center justify-center space-y-4">
              ...
              <p className="text-gray-400">
                Bantu kami memperbarui data lokasi ramah lingkungan atau
                berkontribusi pada pengembangan proyek ini.
              </p>
              <Link
                href="/contact"
                className="mt-4 font-bold py-2 px-6 rounded-md text-white bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600"
              >
                Hubungi Kami
              </Link>
            </div>
