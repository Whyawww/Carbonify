...
export default function LogActionPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  if (!action) return <div className="text-center py-20">Aksi tidak ditemukan.</div>;

  return (
    <div className="min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-4 max-w-lg">
        <div className="mb-8">
          <Link href={`/actions/${id}`} className="text-cyan-400 hover:text-cyan-300">
        ...
        <div className="bg-gray-900/30 backdrop-blur-lg border border-gray-700 p-8 rounded-2xl">
          ...
          <p className="text-sm text-green-400 mb-6">
            Anda akan mendapatkan +{action.points_per_unit} poin untuk setiap {action.unit_name}.
          </p>
