  ...
  return (
    <div className="min-h-screen w-full pt-32 pb-20">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <TypeAnimation
          sequence={[
            'Punya pertanyaan atau masukan? Kami siap mendengar.',
            2000,
          ]}
          wrapper="p"
          speed={50}
        ...
        <div className="p-[1px] bg-gradient-to-r from-green-400/30 to-cyan-400/30 rounded-2xl">
          ...
          >
            ...
            <button
              ...
              className="w-full font-bold py-3 px-6 rounded-md transition-all duration-300 text-white text-lg disabled:opacity-50 bg-gradient-to-r from-green-400 to-cyan-400 hover:from-green-700 hover:to-cyan-700"
            >
              {isSubmitting ? 'Mengirim...' : 'Kirim Pesan'}
            </button>
            {submitMessage && (
              <p className="text-green-400 mt-4 text-center">{submitMessage}</p>
            )}
          </form>
        </div>
      </div>
