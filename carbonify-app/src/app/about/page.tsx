          ...
          <div className="bg-gray-900/80 backdrop-blur-lg p-8 md:p-12 rounded-2xl space-y-8 text-gray-300 text-lg leading-relaxed">
            <p>
              ...
              <strong className="text-white">
                Technology Innovative Challenge 8.0
              </strong>{' '}
              dengan tujuan memberdayakan setiap individu untuk memahami dan
            ...
            <div>
              ...
              <p>
                Misi kami adalah menyediakan alat yang mudah diakses dan
                edukatif bagi masyarakat Indonesia untuk menghitung, memahami,
                dan mengambil langkah konkret dalam mengurangi emisi karbon
                pribadi. Kami ingin mengubah data yang kompleks menjadi wawasan
            ...
            <div>
              ...
              <p>
                Kami membayangkan masa depan di mana setiap orang memiliki
                kesadaran penuh akan dampak lingkungan dari gaya hidup mereka
                dan secara kolektif berkontribusi pada pembangunan yang
                berkelanjutan, menciptakan bumi yang lebih sehat untuk generasi
                yang akan datang.
              </p>
            </div>
          </div>
