...
export default function Home() {
  ...
  const handleCompleteChallenge = async (challengeId: string, points: number) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8000/api/v1/complete-action/', {
        method: 'POST',
        headers: {
      ...
      if (!response.ok) throw new Error(result.error || 'Gagal memperbarui skor.');
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mb-8 md:mb-12">
            ...
            <div className="mb-8 md:mb-10">
              <TypeAnimation
                sequence={[
                  'Tingkatkan kesadaran tentang jejak karbon Anda melalui platform interaktif yang mudah digunakan.', 2000,
                  'Dapatkan insight mendalam tentang dampak aktivitas harian terhadap perubahan iklim.', 2000,
                  'Wujudkan aksi nyata untuk masa depan yang lebih berkelanjutan bersama komunitas peduli lingkungan.', 2000,
                ]}
                wrapper="p"
                speed={50}
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4 lg:space-x-6 mb-12 md:mb-16 px-4">
              <Link href="/calculate" className="group relative bg-gradient-to-r from-green-500 to-emerald-600 hover:from-emerald-600 hover:to-green-500 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12 md:mb-16">
            <div className="group relative overflow-hidden rounded-2xl shadow-2xl">
              <Image src="/images/Jejakkarbon.jpg" alt="Tingkatkan Kesadaran Jejak Karbon" width={400} height={300} className="w-full h-48 sm:h-56 md:h-64 object-cover group-hover:scale-110 transition-transform duration-500" priority />
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-2xl">
              <Image src="/images/Kesadaran.jpg" alt="Dashboard Kesadaran Lingkungan" width={400} height={300} className="w-full h-48 sm:h-56 md:h-64 object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 right-3 md:right-4">
            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-2xl sm:col-span-2 lg:col-span-1">
              <Image src="/images/Aksinyata.jpg" alt="Aksi Nyata Perubahan Iklim" width={400} height={300} className="w-full h-48 sm:h-56 md:h-64 object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
              <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 right-3 md:right-4">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="group relative bg-gradient-to-br from-red-900/30 to-orange-900/30 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-red-500/20 hover:border-red-400/50 transition-all duration-300">
              <StatCard prefix="+" end={1.1} decimals={1} suffix="°C" title="Kenaikan Suhu Global Sejak Era Pra-Industri" />
            ...
            <div className="group relative bg-gradient-to-br from-yellow-900/30 to-orange-900/30 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-yellow-500/20 hover:border-yellow-400/50 transition-all duration-300">
              <StatCard end={2.18} decimals={1} suffix=" Ton CO₂" title="Rata-rata Jejak Karbon Tahunan per Orang Indonesia" />
            ...
            <div className="group relative bg-gradient-to-br from-blue-900/30 to-cyan-900/30 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300">
              <StatCard end={31.9} decimals={1} suffix="%" title="Target Pengurangan Emisi Indonesia di 2030" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="group relative bg-gradient-to-br from-green-900/40 to-emerald-900/40 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-green-500/20 hover:border-green-400/50 transition-all duration-300 transform hover:scale-105">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">1</div>
              <div className="text-center pt-6 md:pt-8">
                <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="4" y="2" width="16" height="20" rx="2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><rect x="7" y="4.5" width="10" height="2" rx="0.5" fill="currentColor" /><circle cx="8" cy="10" r="0.7" fill="currentColor" /><circle cx="12" cy="10" r="0.7" fill="currentColor" /><circle cx="16" cy="10" r="0.7" fill="currentColor" /><circle cx="8" cy="14" r="0.7" fill="currentColor" /><circle cx="12" cy="14" r="0.7" fill="currentColor" /><circle cx="16" cy="14" r="0.7" fill="currentColor" /><circle cx="8" cy="18" r="0.7" fill="currentColor" /><circle cx="12" cy="18" r="0.7" fill="currentColor" /><rect x="15" y="17" width="2" height="2" fill="currentColor" rx="0.5" /></svg>
                </div>
                <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-green-300">Kalkulator Interaktif</h3>
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">Kalkulator jejak karbon akan membantumu melihat seberapa besar dampak aktivitas harianmu terhadap perubahan iklim.</p>
              </div>
            ...
            <div className="group relative bg-gradient-to-br from-cyan-900/40 to-blue-900/40 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-cyan-500/20 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">2</div>
              <div className="text-center pt-6 md:pt-8">
                ...
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">Informasi yang dihasilkan dapat menambah pemahaman yang lebih akurat terhadap jejak karbon dan dampak perubahan iklim.</p>
              </div>
            ...
            <div className="group relative bg-gradient-to-br from-purple-900/40 to-indigo-900/40 p-6 md:p-8 rounded-xl backdrop-blur-sm border border-purple-500/20 hover:border-purple-400/50 transition-all duration-300 transform hover:scale-105">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">3</div>
              <div className="text-center pt-6 md:pt-8">
                ...
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">Bergabunglah dengan komunitas kami dan lakukan aksi nyata untuk menghadapi perubahan iklim dan membawa dampak positif bagi bumi.</p>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-6">
            {weeklyChallenges.map((challenge) => {
              ...
              return (
                <div key={challenge.id} className="p-[1px] bg-gradient-to-r from-green-400/30 to-cyan-400/30 rounded-2xl max-w-2xl mx-auto">
                  <div className="bg-gray-900/80 backdrop-blur-lg p-8 rounded-2xl">
                    <p className="text-cyan-400 font-semibold">{challenge.title}</p>
                    <p className="text-xl md:text-2xl my-4">{challenge.description}</p>
                    <button
                      ...
                      `}
                    >
                      {isCompleted ? 'Selesai' : `Selesaikan (+${challenge.points} Poin)`}
                    </button>
                  </div>
                </div>
              );
